...
<div class="tab-pane fade show active mt-2" id="impressoras-tab-pane" role="tabpanel" aria-labelledby="impressoras-tab" tabindex="0">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-12 col-xl-8" id="impressoras">
            <x-box-input>
                <x-slot:body>
                        ...
                        <table class="table text-center table-bordered w-auto" id="table">
                            ...
                            <tbody id="tbody">
                                @if (count($suprimentos) != 0)
                                    ...
                                    <tr class="linha">
                                        <td><input type="text" name="tipo[]" value="{{ucfirst(strtolower($produto->tipo_produto))}}" disabled class="form-control w-auto"></td>
                                        <td><input type="text" value="{{$produto->modelo_produto}}" disabled class="form-control w-auto"></td>
                                        <td>
