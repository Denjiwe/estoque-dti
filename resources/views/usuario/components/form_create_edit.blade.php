...
@csrf
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4 mt-3 mt-md-0">
            ...
            <select name="user_interno" id="user_interno" class="form-control @error('user_interno') is-invalid @enderror">
        ...
        <div class="col-sm-6 col-md-4 mt-3">
            ...
            <select name="status" id="status" class="form-control @error('user_interno') is-invalid @enderror">
        ...
        <div class="col-sm-12 col-md-6 mt-3">
            ...
            <select name="diretoria_id" id="diretoria" class="form-control @error('diretoria_id') is-invalid @enderror">
        ...
        <div class="col-sm-12 col-md-6 mt-3">
            ...
            <select name="divisao_id" id="divisao" class="form-control @error('divisao_id') is-invalid @enderror">
