        ...
        <div class='accordion-item'>
            <h2 class='accordion-header'>
                <button class='accordion-button collapsed' type='button' data-bs-toggle='collapse'
                    ...
                    <?=$obj->getUsuarioNome()?>,
                    <?=$obj->getUsuarioDivisao() != 0 ? $model->getDivisaoNome($obj->getUsuarioDivisao())['nome'] : $model->getDiretoriaNome($obj->getUsuarioDiretoria())['nome']?>
                    feito em <?=date_format($data, "d/m/Y")?>
                </button>
            </h2>
...
?>
                                                <li class='list-group-item ms-3'>
                                                    ...
                                                    <input class='form-check-input ms-3' type='checkbox' name='id[]'
                                                        value='<?=$item['id']?>' id='checkbox<?=$item['is_id']?>'>
