...
return [
    ...
    */
    ...
    'logo' => '<b>Estoque</b>DTI',
    'logo_img' => 'vendor/adminlte/dist/img/eLogo.png',
    'logo_img_class' => 'brand-image img-circle elevation-5',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Estoque Dti Logo',
        ...
        'DatatablesPlugins' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => url('vendor/datatables/js/jquery.dataTables.min.js'),
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => url('vendor/datatables/js/dataTables.bootstrap4.min.js'),
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => url('vendor/datatables/css/dataTables.bootstrap4.min.css'),
                ],
        ],
        ],
        'Select2' => [
