$('#campo').on('change', function() {
    ...
    switch (valor) {
        case 'id':
            ...
            var newInput = $('<input name="id" type="number" placeholder="Informe o ID" class="form-control" required>');
        ...
        case 'nome':
            ...
            var newInput = $('<input name="nome" type="text" placeholder="Insira o nome do órgão" class="form-control" required>');
