...
- [X] Alteração de solicitações está muito instável, causando alguns problemas
    - [X] Substituição de quantidade solicitada
    - [X] Alterar somente o status de uma solicitação tenta realizar uma nova entrega