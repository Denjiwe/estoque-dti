...
$('#adicionar').click(function() {
    ...
    novaLinha.find('select[id="divisao"]').val('').removeAttr('disabled').addClass('form-select');
    novaLinha.find('select[id="diretoria"]').val('').removeAttr('disabled').addClass('form-select').attr('required');
